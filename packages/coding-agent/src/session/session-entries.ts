...
export interface SessionHeader {
	 ...
	 * or foreign path falls back to `cwd`, raises an
	 * {@link ExecutionCwdFallback} notice without recreating anything, and
	 * persists the header without the rejected binding.
	 */
	executionCwd?: string;
	/**
