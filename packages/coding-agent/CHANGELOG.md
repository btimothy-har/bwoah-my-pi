...
- Fixed same-session reloads re-adopting the persistent session home as the execution directory; tools and LSP now remain bound to the active working directory across reloads ([Bwoah My Pi](https://github.com/btimothy-har/bwoah-my-pi)).
